<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Timeline</strong></h4>
            ...
            <ul class="stepper stepper-vertical colorful-timeline pl-0">
                ...
                <li>
                    ...
                    <div class="step-content z-depth-1 ml-xl-0 p-0 mt-2">
                        ...
                        <p class="text-muted mt-4 px-4"><i class="fa fa-clock-o" aria-hidden="true"></i> 11 hours ago via Twitter</p>
