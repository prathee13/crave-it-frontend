<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Buttons</strong></h4>
      <a href="https://mdbootstrap.com/docs/vue/components/buttons/?utm_source=DemoApp&utm_medium=MDBVuePro" waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank"><mdb-icon icon="graduation-cap" class="mr-2"/>Docs</a>
    </mdb-row>
    <hr class="mb-5" />
    <div class="text-center mt-5">
      <h4 class="pb-2">Gradient buttons</h4>
      ...
      <h4 class="pt-5 pb-2">Rounded buttons</h4>
      ...
      <h4 class="pt-5 pb-2">Rounded outline buttons</h4>
      ...
      <h4 class="pt-5 pb-2">Floating buttons</h4>
...
<script>
import { mdbBtn, mdbBtnGroup, mdbBtnFixed, mdbBtnFixedItem, mdbIcon, mdbContainer, mdbRow } from 'mdbvue';
