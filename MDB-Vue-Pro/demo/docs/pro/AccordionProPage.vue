    ...
    <mdb-container>
      ...
      <mdb-accordion :panes="panesIcon" icon :open="0">
        <ul class="list-unstyled d-flex justify-content-center pt-5 red-text">
          ...
          <li><mdb-icon icon="life-saver" class="mr-3 fa-2x" aria-hidden="true"></mdb-icon></li>
          <li><mdb-icon icon="star-o" class="fa-2x" aria-hidden="true"></mdb-icon></li>
        </ul>
      ...
      <mdb-accordion table >
        <mdb-accordion-pane title="Unfiled items" type="table" :isOpen="openPaneNum==0" @pane-clicked="handlePaneOpened(0)">
          <mdb-dropdown style="display: block" slot="title">
            <mdb-dropdown-toggle color="info" slot="toggle" class="pull-left dropdown mr-3" style="padding: 8px"><mdb-icon icon="pencil"/></mdb-dropdown-toggle>
            ...
            <mdb-tbl class="table table-hover mb-0">
              ...
              <mdb-tbl-body>
                <tr>
                  ...
                  <td>
                    <a>
                      <i class="fa fa-info mx-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tooltip on top"></i>
                    </a>
                    <a>
                      <i class="fa fa-pencil-square mx-1"></i>
                    </a>
                    <a>
          ...
          <mdb-accordion-pane title="Folder 1" type="table" :isOpen="openPaneNum==1" @pane-clicked="handlePaneOpened(1)">
            <mdb-dropdown style="display: block" slot="title">
              <mdb-dropdown-toggle color="info" slot="toggle" class="pull-left dropdown mr-3" style="padding: 8px">
                <mdb-icon icon="pencil" />
              </mdb-dropdown-toggle>
              <mdb-dropdown-menu color="info">
                <mdb-dropdown-item>Add new condition</mdb-dropdown-item>
                <mdb-dropdown-item>Rename folder</mdb-dropdown-item>
