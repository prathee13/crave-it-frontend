            ...
            <mdb-card>
              <div class="header pt-3 peach-gradient">
                ...
                <mdb-row class="mt-2 mb-3 d-flex justify-content-center">
                  <a class="fa-lg p-2 m-2 fb-ic"><mdb-icon class="fa fa-facebook white-text fa-lg"/></a>
                  <a class="fa-lg p-2 m-2 tw-ic"><mdb-icon class="fa fa-twitter white-text fa-lg"/></a>
                  <a class="fa-lg p-2 m-2 gplus-ic"><mdb-icon class="fa fa-google-plus white-text fa-lg"/></a>
                </mdb-row>
              </div>
          ...
          <mdb-col md="5">
            <mdb-card>
              ...
              <div class="footer pt-3 mdb-color lighten-3">
                ...
                <mdb-row class="mt-2 mb-3 d-flex justify-content-center">
                  <a class="fa-lg p-2 m-2 fb-ic"><mdb-icon class="fa fa-facebook white-text fa-lg"> </mdb-icon></a>
                  <a class="fa-lg p-2 m-2 tw-ic"><mdb-icon class="fa fa-twitter white-text fa-lg"> </mdb-icon></a>
                  <a class="fa-lg p-2 m-2 gplus-ic"><mdb-icon class="fa fa-google-plus white-text fa-lg"> </mdb-icon></a>
                </mdb-row>
              </div>
            </mdb-card>
          </mdb-col>
