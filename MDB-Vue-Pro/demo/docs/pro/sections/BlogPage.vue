<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Blog Sections</strong></h4>
        ...
        <mdb-col lg="7">
          <a class="green-text">
            <h6 class="font-weight-bold mb-3">
              <mdb-icon icon="cutlery" class="pr-2" />Food</h6>
          </a>
          ...
          <mdb-card reverse>
            ...
            <mdb-card-body class="text-center" cascade>
              ...
              <mdb-btn class="btn-fb waves-light">
                <mdb-icon icon="facebook" class="pr-2"/>
                mdbIconcebook
              </mdb-btn>
              <span class="counter">46</span>
              <mdb-btn class="btn-tw waves-light">
                <mdb-icon icon="twitter" class="pr-2"/>
                Twitter
              </mdb-btn>
              <span class="counter">22</span>
              <mdb-btn class="btn-gplus waves-light">
                <mdb-icon icon="google-plus" class="pr-2"/>
                mdbGoogle
              </mdb-btn>
