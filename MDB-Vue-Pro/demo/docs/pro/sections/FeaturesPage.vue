<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Features Sections</strong></h4>
    ...
    <mdb-container>
      <section class="text-center my-5">
        ...
        <mdb-row>
          <mdb-col md="4">
            <mdb-icon icon="area-chart" size="3x" class="red-text"/>
          ...
          <mdb-col md="4">
            <mdb-icon icon="comments-o" size="3x" class="orange-text"/>
      ...
      <section class="my-5">
        ...
        <mdb-row>
          ...
          <mdb-col md="4" class="md-0 mb-5">
            <mdb-row>
              <mdb-col lg="2" md="3" size="2">
                <mdb-icon icon="dashboard" size="2x" class="purple-text"/>
              </mdb-col>
              <mdb-col lg="10" md="9" size="10">
      ...
      <section class="my-5">
        ...
        <mdb-row>
          ...
          <mdb-col lg="7">
            <mdb-row class="mb-3">
              <mdb-col size="1">
                <mdb-icon icon="mail-forward" size="lg" class="indigo-text"/>
              </mdb-col>
      ...
      <section class="my-5">
        ...
        <mdb-row>
          <mdb-col md="4">
            ...
            <mdb-row class="mb-3">
              <mdb-col size="2">
                <mdb-icon icon="glass" size="2x" class="deep-purple-text"/>
              </mdb-col>
              <mdb-col size="10">
          ...
          <mdb-col md="4">
            ...
            <mdb-row class="mb-3">
              <mdb-col size="2">
                <mdb-icon icon="flash" size="2x" class="deep-purple-text"/>
              </mdb-col>
              <mdb-col size="10">
