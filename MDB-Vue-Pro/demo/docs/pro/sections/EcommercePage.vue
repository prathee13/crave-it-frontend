<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>eCommerce Sections</strong></h4>
          ...
          <mdb-col lg="4" md="12" class="mb-lg-0 mb-4">
            <mdb-card class="purple-gradient">
              <mdb-card-body class="white-text">
                ...
                <div class="d-flex justify-content-center">
                  <div class="card-circle d-flex justify-content-center align-items-center">
                    <mdb-icon icon="group" class="white-text"></mdb-icon>
                  </div>
                </div>
          ...
          <mdb-col lg="4" md="12" class="mb-lg-0 mb-4">
            <mdb-card>
              <mdb-card-body>
                ...
                <div class="d-flex justify-content-center">
                  <div class="card-circle d-flex justify-content-center align-items-center">
                    <mdb-icon icon="bar-chart" class="light-blue-text"></mdb-icon>
                  </div>
                </div>
          ...
          <mdb-col lg="4" md="12" class="mb-lg-0 mb-4">
            <mdb-card>
              <mdb-card-body>
                ...
                <div class="d-flex justify-content-center">
                  <div class="card-circle d-flex justify-content-center align-items-center">
                    <mdb-icon icon="bar-chart" class="indigo-text"></mdb-icon>
                  </div>
                </div>
                <h2 class="font-weight-bold my-4">99$</h2>
                <p class="grey-text">At ab ea a molestiae corrupti numquam quo beatae minima ratione magni accusantium repellat eveniet quia vitae.</p>
...
<script>
import { mdbContainer, mdbRow, mdbCol, mdbCard,  mdbCardImage, mdbCardBody, mdbCardTitle, mdbCardFooter, mdbCardText, mdbIcon, mdbBtn, Tooltip, mdbBadge, ViewWrapper, mdbCarousel, mdbCarouselItem, mdbCarouselCaption, mdbTestimonial, mdbAvatar, mdbMask  } from 'mdbvue';
