    ...
    <mdb-navbar navStyle="margin-top: 60px" :color="'primary'" position="top" dark href="#" transparent scrolling>
      ...
      <mdb-navbar-toggler style="max-width: 1140px">
        ...
        <mdb-navbar-nav right>
          <mdb-nav-item href="#!" waves-fixed><mdb-icon icon="facebook" class="light-green-text-2"/></mdb-nav-item>
          <mdb-nav-item href="#!" waves-fixed><mdb-icon icon="twitter" class="light-green-text-2"/></mdb-nav-item>
          <mdb-nav-item href="#!" waves-fixed><mdb-icon icon="instagram" class="light-green-text-2"/></mdb-nav-item>
        </mdb-navbar-nav>
      </mdb-navbar-toggler>
    </mdb-navbar>
...
export default {
  ...
  components: {
    mdbContainer, mdbRow, mdbCol, ViewWrapper, mdbMask, mdbBtn, mdbIcon, mdbNavbar, mdbNavItem, mdbNavbarNav, mdbNavbarToggler, mdbNavbarBrand
  }
