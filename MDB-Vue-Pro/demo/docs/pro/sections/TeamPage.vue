<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Team Sections</strong></h4>
        ...
        <mdb-row>
          ...
          <mdb-col lg="3" md="6"  class="mb-lg-0 mb-5">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <a class="p-2 fa-lg">
                <mdb-icon icon="dribbble" class="blue-text"/>
              </a>
            </ul>
          </mdb-col>
          ...
          <mdb-col lg="3" md="6"  class="mb-lg-0 mb-5">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <a class="p-2 fa-lg">
                <mdb-icon icon="github" class="blue-text"/>
              </a>
            </ul>
          </mdb-col>
        </mdb-row>
