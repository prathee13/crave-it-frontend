<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Project Sections</strong></h4>
      ...
      <section class="text-center my-5">
        ...
        <mdb-row class="d-flex justify-content-center">
          <mdb-col md="6" xl="5" class="mb-4">
            ...
            <mdb-card-body class="pb-0">
              <a href="" class="green-text"><h5 class="font-weight-bold mt-2 mb-3"><mdb-icon icon="line-chart" class="pr-2"/>Marketing</h5></a>
      ...
      <section class="my-5">
        ...
        <mdb-row>
          ...
          <mdb-col lg="7">
            <mdb-row class="mb-3">
              <mdb-col md="1" size="2">
                <mdb-icon icon="bar-chart" size="2x" class="indigo-text"/>
              </mdb-col>
            ...
            <mdb-row class="mb-3">
              <mdb-col md="1" size="2">
                <mdb-icon icon="smile-o" size="2x" class="blue-text"/>
              </mdb-col>
              <mdb-col md="11" size="10">
        ...
        <mdb-row>
          <mdb-col lg="7">
            ...
            <mdb-row class="mb-3">
              <mdb-col md="1" size="2">
                <mdb-icon icon="money" size="2x" class="deep-purple-text"/>
              </mdb-col>
              <mdb-col md="11" size="10">
