<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Testimonials Sections</strong></h4>
          ...
          <mdb-col lg="4" md="6" class="mb-lg-0 mb-4">
            <mdb-card testimonial>
              ...
              <mdb-card-body>
                ...
                <hr/>
                <p class="dark-grey-text mt-4"><i class="fa fa-quote-left pr-2"></i>Neque cupiditate assumenda in maiores repudiandae mollitia architecto.</p>
              </mdb-card-body>
            </mdb-card>
          </mdb-col>
          <mdb-col lg="4" md="6" class="mb-lg-0 mb-4">
            <mdb-card testimonial>
              ...
              <mdb-card-body>
                ...
                <hr/>
                <p class="dark-grey-text mt-4"><i class="fa fa-quote-left pr-2"></i>Delectus impedit saepe officiis ab aliquam repellat rem unde ducimus.</p>
              </mdb-card-body>
            </mdb-card>
          </mdb-col>
        </mdb-row>
        ...
        <mdb-carousel testimonial fade :interval="5000" showControls>
          <mdb-carousel-item>
            <mdb-testimonial>
              ...
              <mdb-icon icon="star" class="blue-text"/>
              <mdb-icon icon="star" class="blue-text"/>
              <mdb-icon icon="star-half-full" class="blue-text"/>
            </mdb-testimonial>
          </mdb-carousel-item>
          <mdb-carousel-item>
            <mdb-testimonial>
        ...
        <mdb-row class="text-center">
          <mdb-col md="4" class="mb-md-0 mb-5">
            <mdb-testimonial>
              ...
              <p class="font-weight-normal dark-grey-text">
                <mdb-icon class="fa fa-quote-left pr-2"/>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod eos id officiis hic tenetur quae quaerat ad velit ab hic tenetur.</p>
              <div class="orange-text">
                <mdb-icon icon="star"/>
                <mdb-icon icon="star"/>
                <mdb-icon icon="star"/>
                <mdb-icon icon="star"/>
                <mdb-icon icon="star-half-full"/>
              </div>
            </mdb-testimonial>
          </mdb-col>
          <mdb-col md="4" class="mb-md-0 mb-5">
            <mdb-testimonial>
              ...
              <p class="font-weight-normal dark-grey-text">
                <mdb-icon class="fa fa-quote-left pr-2"/>Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid commodi.</p>
              <div class="orange-text">
                <mdb-icon icon="star"/>
                <mdb-icon icon="star"/>
                <mdb-icon icon="star"/>
          ...
          <mdb-col md="4">
            <mdb-testimonial>
              ...
              <p class="font-weight-normal dark-grey-text">
                <mdb-icon class="fa fa-quote-left pr-2"/>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti.</p>
              <div class="orange-text">
                <mdb-icon icon="star"/>
                <mdb-icon icon="star"/>
                <mdb-icon icon="star"/>
