<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Magazine Sections</strong></h4>
        ...
        <mdb-col lg="6" md="12">
          <div class="news">
            ...
            <div class="d-flex justify-content-between">
              ...
              <p class="font-weight-bold dark-grey-text"><mdb-icon icon="clock-o" class="pr-2"/>20/08/2018</p>
            </div>
        ...
        <mdb-col lg="6" md="12">
          <div class="news">
            ...
            <div class="d-flex justify-content-between">
              ...
              <p class="font-weight-bold dark-grey-text"><mdb-icon icon="clock-o" class="pr-2"/>24/08/2018</p>
            </div>
            <h3 class="font-weight-bold dark-grey-text mb-3 p-0"><a>Title of the news</a></h3>
      ...
      <mdb-row>
        <mdb-col md="12" lg="6">
          <div class="mb-4">
            ...
            <div class="d-flex justify-content-between">
              <a class="deep-orange-text"><h6 class="font-weight-bold"><mdb-icon icon="cutlery" class="pr-2"/>Culinary</h6></a>
              <p class="font-weight-bold dark-grey-text"><mdb-icon icon="clock-o" class="pr-2"/>27/02/2018</p>
            </div>
            <h3 class="font-weight-bold dark-grey-text mb-3 p-0"><a>Title of the news</a></h3>
