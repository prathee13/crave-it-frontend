<template>
  <mdb-container>
    <mdb-row class="mt-5 align-items-center justify-content-start">
      <h4 style="margin: 0" class="grey-text"><strong>Multiselect</strong></h4>
    ...
    <mdb-container class="mt-5">
      <h4 class="pt-4 pb-3">Standard multiselect</h4>
      <mdb-row>
        <mdb-col sm="6">
          <mdb-select multiple selectAll @getValue="getSelectValue" :options="countries" />
        </mdb-col>
      </mdb-row>
      <h4 class="pt-4 pb-3">Multiselect with label</h4>
      <mdb-row>
        <mdb-col sm="6">
      ...
      <h4 class="pt-4 pb-3">Colorful Multiselect with label</h4>
      <mdb-row>
        <mdb-col sm="6">
      ...
      <h4 class="pt-4 pb-3">Colorful Multiselect with label and search box</h4>
      <mdb-row>
        <mdb-col sm="6">
      ...
      <h4 class="pt-4 pb-3">Multiselect with options groups and search box</h4>
      <mdb-row>
        <mdb-col sm="6">
      ...
      <h4 class="pt-4 pb-3">Multiselect with icons and search box</h4>
      <mdb-row>
        <mdb-col sm="6">
