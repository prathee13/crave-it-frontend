    ...
    <mdb-row>
      <mdb-col md="8" class="mx-auto">
        <mdb-jumbotron class="mt-5">
          ...
          <mdb-list-group>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/plugins/pro/chat">
              <h5 class="justify-content-between d-flex align-items-center">
                Chat <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/plugins/pro/streak">
              <h5 class="justify-content-between d-flex align-items-center">
                Streak <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/plugins/pro/timeline">
              <h5 class="justify-content-between d-flex align-items-center">
                Timeline <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/plugins/pro/video">
              <h5 class="justify-content-between d-flex align-items-center">
                Video<mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
