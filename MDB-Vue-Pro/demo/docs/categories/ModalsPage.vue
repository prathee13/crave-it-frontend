    ...
    <mdb-row>
      <mdb-col md="8" class="mx-auto">
        <mdb-jumbotron class="mt-5">
          ...
          <mdb-list-group>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/modals/pro/examples">
              <h5 class="justify-content-between d-flex align-items-center">
                Examples<mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
          ...
          <mdb-list-group>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/modals/pro/forms">
              <h5 class="justify-content-between d-flex align-items-center">
                Forms<mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
