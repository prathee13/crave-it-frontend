      ...
      <mdb-col md="8" class="mx-auto">
        <mdb-jumbotron class="mt-5">
          ...
          <mdb-list-group>
            ...
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/accordion">
              <h5 class="justify-content-between d-flex align-items-center">
                Accordion <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/carousel">
              <h5 class="justify-content-between d-flex align-items-center">
                Carousel <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/chart">
              <h5 class="justify-content-between d-flex align-items-center">
                Charts <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/gallery">
              <h5 class="justify-content-between d-flex align-items-center">
                Gallery <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/lightbox">
              <h5 class="justify-content-between d-flex align-items-center">
                Lightbox <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/multicarousel">
              <h5 class="justify-content-between d-flex align-items-center">
                Multi-item carousel <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/notify">
              <h5 class="justify-content-between d-flex align-items-center">
                Notifications<mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/scrollbar">
              <h5 class="justify-content-between d-flex align-items-center">
                Scrollbar <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/sticky">
              <h5 class="justify-content-between d-flex align-items-center">
                StickyContent <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/advanced/pro/thumbnailscarousel">
              <h5 class="justify-content-between d-flex align-items-center">
