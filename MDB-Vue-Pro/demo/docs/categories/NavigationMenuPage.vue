    ...
    <mdb-row>
      <mdb-col md="8" class="mx-auto">
        <mdb-jumbotron class="mt-5">
          ...
          <mdb-list-group>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/navigation/pro/double-navigation">
              <h5 class="justify-content-between d-flex align-items-center">
                Double Navigation <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/navigation/pro/footer">
              <h5 class="justify-content-between d-flex align-items-center">
                Footer <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/navigation/pro/hamburger">
              <h5 class="justify-content-between d-flex align-items-center">
                Hamburger Menu <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/navigation/pro/megamenu">
              <h5 class="justify-content-between d-flex align-items-center">
                Mega Menu <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/navigation/pro/scrollspy">
              <h5 class="justify-content-between d-flex align-items-center">
                ScrollSpy <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/navigation/pro/sidenav">
              <h5 class="justify-content-between d-flex align-items-center">
