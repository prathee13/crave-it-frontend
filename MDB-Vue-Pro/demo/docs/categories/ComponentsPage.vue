    ...
    <mdb-row>
      <mdb-col md="8" class="mx-auto">
        <mdb-jumbotron class="mt-5">
          ...
          <mdb-list-group>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/button">
              <h5 class="justify-content-between d-flex align-items-center">
                Button <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/card">
              <h5 class="justify-content-between d-flex align-items-center">
                Card <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/chips">
              <h5 class="justify-content-between d-flex align-items-center">
                Chips <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/dropdown">
              <h5 class="justify-content-between d-flex align-items-center">
                Dropdown <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/card-extended">
              <h5 class="justify-content-between d-flex align-items-center">
                Extended Cards <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/pills">
              <h5 class="justify-content-between d-flex align-items-center">
                Pills <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/progress-bars-pro">
              <h5 class="justify-content-between d-flex align-items-center">
                Progress Bar <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/slider">
              <h5 class="justify-content-between d-flex align-items-center">
                Slider <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/stepper">
              <h5 class="justify-content-between d-flex align-items-center">
                Stepper <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/components/pro/tabs">
              <h5 class="justify-content-between d-flex align-items-center">
                Tabs <mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
