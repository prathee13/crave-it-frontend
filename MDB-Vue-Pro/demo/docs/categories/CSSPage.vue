    ...
    <mdb-row>
      <mdb-col md="8" class="mx-auto">
        <mdb-jumbotron class="mt-5">
          ...
          <mdb-list-group>
            <mdb-nav-item class="list-group-item list-group-item-action" router href="/css/pro/gradient">
              <h5 class="justify-content-between d-flex align-items-center">
                Gradient<mdb-icon icon="angle-right"/>
              </h5>
            </mdb-nav-item>
            <!-- <mdb-nav-item class="list-group-item list-group-item-action" router href="/css/pro/parallax">
              <h5 class="justify-content-between d-flex align-items-center">
